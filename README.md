...
| [![Conda Recipe](https://img.shields.io/badge/recipe-dagster--bash-green.svg)](https://anaconda.org/conda-forge/dagster-bash) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/dagster-bash.svg)](https://anaconda.org/conda-forge/dagster-bash) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/dagster-bash.svg)](https://anaconda.org/conda-forge/dagster-bash) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/dagster-bash.svg)](https://anaconda.org/conda-forge/dagster-bash) |
...
Once the `conda-forge` channel has been enabled, `dagit, dagster, dagster-bash, dagster-cron, dagster-datadog, dagster-dbt, dagster-ge, dagster-github, dagster-graphql, dagster-pagerduty, dagster-pandas, dagster-papertrail, dagster-postgres, dagster-prometheus, dagster-slack, dagster-snowflake, dagster-spark, dagster-ssh, dagster-twilio` can be installed with:

```
conda install dagit dagster dagster-bash dagster-cron dagster-datadog dagster-dbt dagster-ge dagster-github dagster-graphql dagster-pagerduty dagster-pandas dagster-papertrail dagster-postgres dagster-prometheus dagster-slack dagster-snowflake dagster-spark dagster-ssh dagster-twilio
```
