...
Once the `conda-forge` channel has been enabled, `dagit, dagster, dagster-celery, dagster-celery-docker, dagster-cron, dagster-dask, dagster-datadog, dagster-dbt, dagster-github, dagster-graphql, dagster-k8s, dagster-pagerduty, dagster-pandas, dagster-papertrail, dagster-postgres, dagster-prometheus, dagster-shell, dagster-slack, dagster-snowflake, dagster-spark, dagster-ssh, dagster-twilio` can be installed with:

```
conda install dagit dagster dagster-celery dagster-celery-docker dagster-cron dagster-dask dagster-datadog dagster-dbt dagster-github dagster-graphql dagster-k8s dagster-pagerduty dagster-pandas dagster-papertrail dagster-postgres dagster-prometheus dagster-shell dagster-slack dagster-snowflake dagster-spark dagster-ssh dagster-twilio
```
