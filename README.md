...
Once the `conda-forge` channel has been enabled, `dagster, dagster-airflow, dagster-aws, dagster-celery, dagster-dask, dagster-gcp, dagster-graphql, dagster-pyspark, dagstermill` can be installed with:

```
conda install dagster dagster-airflow dagster-aws dagster-celery dagster-dask dagster-gcp dagster-graphql dagster-pyspark dagstermill
```
