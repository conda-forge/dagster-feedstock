...
Once the `conda-forge` channel has been enabled, `dagit, dagster, dagster-aws, dagster-bash, dagster-cron, dagster-dask, dagster-datadog, dagster-dbt, dagster-gcp, dagster-ge, dagster-graphql, dagster-pagerduty, dagster-pandas, dagster-papertrail, dagster-postgres, dagster-pyspark, dagster-slack, dagster-snowflake, dagster-spark, dagster-ssh, dagster-twilio` can be installed with:

```
conda install dagit dagster dagster-aws dagster-bash dagster-cron dagster-dask dagster-datadog dagster-dbt dagster-gcp dagster-ge dagster-graphql dagster-pagerduty dagster-pandas dagster-papertrail dagster-postgres dagster-pyspark dagster-slack dagster-snowflake dagster-spark dagster-ssh dagster-twilio
```
