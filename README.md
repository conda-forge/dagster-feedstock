...
| [![Conda Recipe](https://img.shields.io/badge/recipe-dagster--azure-green.svg)](https://anaconda.org/conda-forge/dagster-azure) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/dagster-azure.svg)](https://anaconda.org/conda-forge/dagster-azure) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/dagster-azure.svg)](https://anaconda.org/conda-forge/dagster-azure) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/dagster-azure.svg)](https://anaconda.org/conda-forge/dagster-azure) |
...
Once the `conda-forge` channel has been enabled, `dagster, dagster-airflow, dagster-aws, dagster-azure, dagster-celery, dagster-dask, dagster-gcp, dagster-graphql, dagster-pyspark, dagstermill` can be installed with:

```
conda install dagster dagster-airflow dagster-aws dagster-azure dagster-celery dagster-dask dagster-gcp dagster-graphql dagster-pyspark dagstermill
```

It is possible to list all of the versions of `dagster` available on your platform with:

```
conda search dagster --channel conda-forge
```
