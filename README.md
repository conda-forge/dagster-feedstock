...
Once the `conda-forge` channel has been enabled, `dagit, dagster, dagster-airbyte, dagster-airflow, dagster-celery, dagster-celery-docker, dagster-celery-k8s, dagster-dask, dagster-datadog, dagster-dbt, dagster-docker, dagster-fivetran, dagster-gcp, dagster-ge, dagster-github, dagster-graphql, dagster-k8s, dagster-mlflow, dagster-msteams, dagster-mysql, dagster-pagerduty, dagster-pandas, dagster-papertrail, dagster-postgres, dagster-prometheus, dagster-pyspark, dagster-shell, dagster-slack, dagster-snowflake, dagster-spark, dagster-ssh, dagster-twilio, dagstermill` can be installed with:

```
conda install dagit dagster dagster-airbyte dagster-airflow dagster-celery dagster-celery-docker dagster-celery-k8s dagster-dask dagster-datadog dagster-dbt dagster-docker dagster-fivetran dagster-gcp dagster-ge dagster-github dagster-graphql dagster-k8s dagster-mlflow dagster-msteams dagster-mysql dagster-pagerduty dagster-pandas dagster-papertrail dagster-postgres dagster-prometheus dagster-pyspark dagster-shell dagster-slack dagster-snowflake dagster-spark dagster-ssh dagster-twilio dagstermill
```
